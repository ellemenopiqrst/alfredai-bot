...
import FormData from 'form-data'  // Mailgun requires this for Node.js

const apiKey = process.env.MAILGUN_API_KEY
const domain = process.env.MAILGUN_DOMAIN
if (!apiKey || !domain) throw new Error('Missing MAILGUN_API_KEY or MAILGUN_DOMAIN')

const mailgun = new Mailgun(FormData).client({ username: 'api', key: apiKey })
          ...
          <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #334155; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f8fafc; padding: 30px; border-radius: 12px; border: 1px solid #e2e8f0;">
              ...
              <ul style="list-style: none; padding: 0;">
                <li style="margin: 10px 0;">✨ <a href="https://alfredai-bot.vercel.app" style="color: #ec4899; text-decoration: none;">Product Features</a></li>
                <li style="margin: 10px 0;">📚 <a href="https://alfredai-bot.vercel.app" style="color: #ec4899; text-decoration: none;">Case Studies</a></li>
                <li style="margin: 10px 0;">🎯 <a href="https://alfredai-bot.vercel.app" style="color: #ec4899; text-decoration: none;">Resources</a></li>
              </ul>
            </div>
            <div style="margin-top: 30px; padding: 20px; background: white; border-radius: 12px; border: 1px solid #e2e8f0; text-align: center;">
              <p style="margin: 0; color: #64748b; font-size: 14px;">Need immediate assistance? Reply to this email.</p>
            </div>
...
export async function sendNotificationEmail(formData) {
  try {
    ...
    console.error('Mailgun notification error:', error)
    throw error
  }
}